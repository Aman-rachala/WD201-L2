...
let date = todaydates.getDate();
let todaymonth = todaydates.getMonth() + 1; //January is 0 so need to add 1 to make it 1!
...
maxDate = year - 18 + '-' + todaymonth + '-' + date;
minDate = year - 55 + '-' + todaymonth + '-' + date;
